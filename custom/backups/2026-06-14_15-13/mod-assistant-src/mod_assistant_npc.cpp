...
bool Assistant::OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
{
    ...
    else if (action == ASSISTANT_GOSSIP_HEIRLOOM)
    {
        ...
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_DREADMIST, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 2);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_SHADOWCRAFT, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 3);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_WILDHEART, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 4);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_ELEMENTS, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 5);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_LIGHTFORGE, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 6);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_MIGHT, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 7);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_MISC, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 8);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_T2SETS, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 20);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_LEGENDARY, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 30);
        AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_PREVIOUS_PAGE, GOSSIP_SENDER_MAIN, 1);
        SendGossipMenuFor(player, ASSISTANT_GOSSIP_TEXT, creature->GetGUID());
    }
    else if (action >= ASSISTANT_GOSSIP_HEIRLOOM + 1 && action <= ASSISTANT_GOSSIP_HEIRLOOM + 8)
    {
        uint32 id = 0;
        ...
        case ASSISTANT_GOSSIP_HEIRLOOM + 2:
            id = ASSISTANT_VENDOR_HEIRLOOM_DREADMIST;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 3:
            id = ASSISTANT_VENDOR_HEIRLOOM_SHADOWCRAFT;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 4:
            id = ASSISTANT_VENDOR_HEIRLOOM_WILDHEART;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 5:
            id = ASSISTANT_VENDOR_HEIRLOOM_ELEMENTS;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 6:
            id = ASSISTANT_VENDOR_HEIRLOOM_LIGHTFORGE;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 7:
            id = ASSISTANT_VENDOR_HEIRLOOM_MIGHT;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 8:
            id = ASSISTANT_VENDOR_HEIRLOOM_MISC;
            break;
        }
    ...
    {
        ClearGossipMenuFor(player);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_NEMESIS, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 21);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_JUDGEMENT, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 22);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_BLOODFANG, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 23);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_NETHERWIND, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 24);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_TRANSCENDENCE, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 25);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_STORMRAGE, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 26);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_TEN_STORMS, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 27);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_DRAGONSTALKER, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 28);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_WRATH, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 29);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_HEIRLOOMS_CORRUPTOR, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM + 40);
        AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_PREVIOUS_PAGE, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_HEIRLOOM);
        SendGossipMenuFor(player, ASSISTANT_GOSSIP_TEXT, creature->GetGUID());
    }
    // Tier 2 set vendor windows
    else if (action >= ASSISTANT_GOSSIP_HEIRLOOM + 21 && action <= ASSISTANT_GOSSIP_HEIRLOOM + 29)
    {
        uint32 id = 0;
        switch (action)
        {
        case ASSISTANT_GOSSIP_HEIRLOOM + 21:
            id = ASSISTANT_VENDOR_HEIRLOOM_NEMESIS;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 22:
            id = ASSISTANT_VENDOR_HEIRLOOM_JUDGEMENT;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 23:
            id = ASSISTANT_VENDOR_HEIRLOOM_BLOODFANG;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 24:
            id = ASSISTANT_VENDOR_HEIRLOOM_NETHERWIND;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 25:
            id = ASSISTANT_VENDOR_HEIRLOOM_TRANSCENDENCE;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 26:
            id = ASSISTANT_VENDOR_HEIRLOOM_STORMRAGE;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 27:
            id = ASSISTANT_VENDOR_HEIRLOOM_TEN_STORMS;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 28:
            id = ASSISTANT_VENDOR_HEIRLOOM_DRAGONSTALKER;
            break;
        case ASSISTANT_GOSSIP_HEIRLOOM + 29:
            id = ASSISTANT_VENDOR_HEIRLOOM_WRATH;
            break;
        }
        player->GetSession()->SendListInventory(creature->GetGUID(), id);
    }
    ...
    {
        player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_HEIRLOOM_CORRUPTOR);
    }
    // Legendary weapons - open single vendor directly
    else if (action == ASSISTANT_GOSSIP_HEIRLOOM + 30)
    {
        player->GetSession()->SendListInventory(creature->GetGUID(), ASSISTANT_VENDOR_HEIRLOOM_LEGENDARY);
    }
